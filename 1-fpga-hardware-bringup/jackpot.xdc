##DIP switches
set_property PACKAGE_PIN G15 [ get_ports {DIP[0] } ]
set_property IOSTANDARD LVCMOS33 [ get_ports {DIP[0] } ]

set_property PACKAGE_PIN P15 [ get_ports {DIP[1] } ]
set_property IOSTANDARD LVCMOS33 [ get_ports {DIP[1] } ]

set_property PACKAGE_PIN W13 [ get_ports {DIP[2] } ]
set_property IOSTANDARD LVCMOS33 [ get_ports {DIP[2] } ]

set_property PACKAGE_PIN T16 [ get_ports {DIP[3] } ]
