...
In this repository, the constraint files and Verilog source files are located in different directories due to the default project structure generated by Vivado.

**Constraint Files**

The following constraint files are located directly inside the project folder: 1-fpga-hardware-bringup/
- switch.xdc
- counter.xdc
- jackpot.xdc
...
The Verilog design files are located inside the Vivado source directory generated during project creation: 1-fpga-hardware-bringup/lab_1.srcs/sources_1/new/
- switch.v
- counter.v
- jackpot.v

This directory structure follows the default layout created by Vivado for RTL source management.
---
